...
void Mouse::OnLeftPressed( int ,int  )
{
	leftIsPressed = true;
...
void Mouse::OnLeftReleased( int ,int  )
{
	leftIsPressed = false;
...
void Mouse::OnRightPressed( int ,int  )
{
	rightIsPressed = true;
...
void Mouse::OnRightReleased( int ,int  )
{
...
void Mouse::OnWheelUp( int ,int  )
{
	buffer.push( Mouse::Event( Mouse::Event::WheelUp,*this ) );
	TrimBuffer();
}

void Mouse::OnWheelDown( int ,int  )
{
